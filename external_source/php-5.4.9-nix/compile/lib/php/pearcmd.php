 ...
 * @nodep Gtk
 */
if ('/home/frank/Bureau/eWAP/external_source/php-5.4.9-nix/compile/lib/php' != '@'.'include_path'.'@') {
    ini_set('include_path', '/home/frank/Bureau/eWAP/external_source/php-5.4.9-nix/compile/lib/php');
    $raw = false;
} else {
